...
class BinaryTreeCousinsAcceptanceTests(unittest.TestCase):
    ...
    def test_are_cousins_false_when_siblings_at_third_level(self):
    ...
    def test_are_cousins_true_when_dif_parent_same_depth_at_third_level(self):
        root = [1, 2, 3, None, 4, None, 5, 6, 7, 8, 9]
        x = 7
        y = 8
        result = are_cousins(root, x, y)
...
class BinaryTreeCousinsUnitTests(unittest.TestCase):
    ...
    def test_get_depth_right_most_node_at_second_level(self):
        root = [1, 2, 3, 4, 5, 6, 7]
        node = 7
        result = get_depth(root, node)
        self.assertEqual(result, 2)

    def test_get_depth_inner_node_at_second_level(self):
        root = [1, 2, 3, 4, 5, 6, 7]
        node = 5
        result = get_depth(root, node)
        self.assertEqual(result, 2)
    ...
    def test_get_depth_left_most_node_at_third_level(self):
        first_level = [2, 3]
        second_level = [4, 5, 6, 7]
        third_level = [8, 9, 10, 11, 12, 13, 14, 15]
        root = [1, *first_level, *second_level, *third_level]
        node = 8
        result = get_depth(root, node)
        self.assertEqual(result, 3)

    def test_get_depth_right_most_node_at_third_level(self):
        first_level = [2, 3]
        second_level = [4, 5, 6, 7]
        third_level = [8, 9, 10, 11, 12, 13, 14, 15]
        root = [1, *first_level, *second_level, *third_level]
    ...
    def test_get_depth_inner_node_at_third_level(self):
        first_level = [2, 3]
        second_level = [4, 5, 6, 7]
        third_level = [8, 9, 10, 11, 12, 13, 14, 15]
        root = [1, *first_level, *second_level, *third_level]
